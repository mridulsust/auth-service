...
schema_view = get_schema_view(
   openapi.Info(
      title="API Endpoints",
      default_version='v1',
      description="API endpoints for auth-service",
      terms_of_service="https://www.google.com/policies/terms/",
      contact=openapi.Contact(email="mridulsust@gmail.com"),
...
api_patterns = ([
    ...
    # Users
    path("users/", include("auth_service.users.rest_api.urls", namespace="users")),
    # Authentication
